...
# backend trait
function solve_displacement!(stokes::JustRelax.StokesArrays, args...; kwargs)
    out = solve_displacement!(backend(stokes), stokes, args...; kwargs)
    return out
end

# entry point for extensions
function solve_displacement!(::CPUBackendTrait, stokes, args...; kwargs)
    return _solve_displacement!(stokes, args...; kwargs...)
end
